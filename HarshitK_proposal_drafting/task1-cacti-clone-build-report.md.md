...
From my understanding, Hyperledger Cacti is a pluggable tool that lets different blockchains talk to each other and share information without having to merge into a single network.
...
## My Build experience
I built Hyperledger Cacti by first cloning the repository, then opened it in VS Code and building it inside the Dev Container to match the project’s expected setup as mentioned in BUILD.md.
