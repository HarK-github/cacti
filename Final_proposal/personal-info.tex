...
% Project Info
\newcommand{\projecttitle}{Hyperledger Fabric-X + Fablo Integration}
\newcommand{\program}{OpenSSF LFX Mentorship 2026}
\newcommand{\mentors}{Umegbewe 'Great' Nwebedu, Osama Rabea, and Jakub Dzikowski}
\newcommand{\committee}{OpenSSF Mentorship Program Committee}
